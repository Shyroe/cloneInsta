...
- Add user authentication with jsonwebtokens
- Add post and user relacion
- Create feature of user comments in different posts
- Implement feature to upload image (backend)
...
**Answer**: React; bootstrap; jsonwebtokens; mongodb; bcryptjs.
